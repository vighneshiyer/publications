...
\title[TidalSim: A Unified Microarchitectural Simulation Framework]{TidalSim: A Unified Microarchitectural Simulation Framework}
\subtitle{To Identify and Leverage Unique Aspects of Workloads on Heterogeneous SoCs for Performance Estimation and Verification}

\author[Vighnesh Iyer]{Vighnesh Iyer}

\date{\today}

\publishers{PhD Thesis, UC Berkeley}
...
\addpart{Introduction and Background}
...
\input{chapters/trace_driven_sim.tex}
