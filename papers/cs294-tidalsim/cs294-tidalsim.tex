...
% each interval sees a cold start for all the long-lived microarchitectural state blocks
...
\begin{figure}
  \includegraphics[width=0.7\linewidth]{dynamic/tidalsim/uarch_models.pdf}
