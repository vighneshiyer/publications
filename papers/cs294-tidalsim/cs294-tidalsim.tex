...
Cycle-level or trace-based simulators suffer from low accuracy and unbounded errors which are further exacerbated by sampled simulation which adds sampling error on top of modeling error.
...
We need some way to combine the accuracy of RTL simulation
